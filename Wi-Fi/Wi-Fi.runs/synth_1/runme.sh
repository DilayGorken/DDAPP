...
HD_PWD='C:/Users/ARGE2/Desktop/Projeler/fpga-iot/esp8266/esp8266.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WifiTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WifiTopLevel.tcl
