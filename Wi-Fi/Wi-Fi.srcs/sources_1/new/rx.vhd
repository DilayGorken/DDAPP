...
entity rx is
    Port ( clk : in STD_LOGIC;
           rx_in : in STD_LOGIC;                        
           data : out STD_LOGIC_VECTOR (7 downto 0);    -- okunacak veriyi belirtir
           data_enable : out STD_LOGIC);                --
end rx;

architecture Behavioral of rx is
    signal baud_count       : unsigned(13 downto 0) := (others => '0'); --baund sayacý
    constant baud_count_max : unsigned(13 downto 0) := to_unsigned(100000000/115200, 14); --baud geniþliði tanýmlamasý 
    signal busy                : std_logic:= '0';                                         -- busy sinyali belirteci
    signal receiving           : std_logic_vector(7 downto 0) := (others => '0');         -- iletilecek data 
    signal rx_in_last          : std_logic:= '1';                                          -- 
    signal rx_in_synced        : std_logic:= '1';                                          -- senkronizasyon saðlandý
