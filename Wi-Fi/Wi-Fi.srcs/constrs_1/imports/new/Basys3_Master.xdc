...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {BT_UART_RXD}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BT_UART_RXD}]
#Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {BT_UART_TXD}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BT_UART_TXD}]
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {BT_UART_RXD}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {BT_UART_RXD}]
##Sch name = JC4
...
##Sch name = JC8
    set_property PACKAGE_PIN M19 [get_ports {wifi_tx}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {wifi_tx}]
    #Sch name = JC9
    set_property PACKAGE_PIN P17 [get_ports wifi_rx]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {wifi_rx}]
    #Sch name = JC10
