...
HD_PWD='D:/vivadoprojectsNEW/vivadoprojectslast/DDAPP/uygulama kodlar emranin hali/ADC/ADC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc.tcl -notrace
