...
HD_PWD='D:/vivadoprojectsNEW/vivadoprojectslast/DDAPP/BluetoothLast/BluetoothLast.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serialport.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serialport.tcl
