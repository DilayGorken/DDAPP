...
HD_PWD='D:/vivadoprojectsNEW/vivadoprojectslast/DDAPP/BluetoothLast/BluetoothLast.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serialport.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serialport.tcl -notrace
