...
HD_PWD='D:/vivadoprojectsNEW/SevenSegmentDisplayLast/SevenSegmentDisplayLast.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentDisplayDesign.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegmentDisplayDesign.tcl
