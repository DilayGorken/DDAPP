...
HD_PWD='D:/vivadoprojectsNEW/SevenSegmentDisplayLast/SevenSegmentDisplayLast.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentDisplayDesign.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegmentDisplayDesign.tcl -notrace
