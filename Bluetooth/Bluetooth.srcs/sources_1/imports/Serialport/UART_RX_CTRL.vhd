...
architecture behavioral of UART_RX_CTRL is
    ...
    constant BAUD : integer := 9600;       -- Bit rate of serial comms (bit hızı) 
    ...
    constant sample_0: integer := 3 * FREQ/(BAUD*2)-1;                     --3*(100_000_000/(9600*2))-1  = 15.624
    constant sample_1: integer := 5 * FREQ/(BAUD*2)-1;                     -- = 26.040,66666666667
