...
clk_yavas<=clk_sayici(11); --100_000_000_000   clk_sayici reset 1 olduğu sürece clk gibi hareket eder 
                            -- clk_yavas ise 1 sn sonra değişime uğrayacak dolayısıyla 1 sn boyunca sabit kalacak 0/1

process(clk_yavas,rst)   --bu process e de uygulanan delay ile girilecek yani 1sn sonunda clk_yavas değiştiğinde
begin
	...
	elsif rising_edge(clk_yavas) then     --clk_yavas' ın değişiminde;
